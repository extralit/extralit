...
> \[!NOTE\] For changes in the argilla-server module, visit the argilla-server [release notes](https://github.com/argilla-io/argilla-server/releases/tag/v1.25.0)
...
> \[!NOTE\] This release does not contain any new features, but it includes a major change in the `argilla-server` dependency. The package is using the `argilla-server` dependency defined [here](https://github.com/argilla-io/argilla-server). ([#4537](https://github.com/argilla-io/argilla/pull/4537))
...
- Disallow `fields` and `questions` in `FeedbackDataset` with the same name ([#3126](https://github.com/argilla-io/argilla/pull/3126)).
...
- `/api/v1/datasets` new endpoint to list and create datasets ([#2615](https://github.com/argilla-io/argilla/issues/2615)).
- `/api/v1/datasets/{dataset_id}` new endpoint to get and delete datasets ([#2615](https://github.com/argilla-io/argilla/issues/2615)).
- `/api/v1/datasets/{dataset_id}/publish` new endpoint to publish a dataset ([#2615](https://github.com/argilla-io/argilla/issues/2615)).
- `/api/v1/datasets/{dataset_id}/questions` new endpoint to list and create dataset questions ([#2615](https://github.com/argilla-io/argilla/issues/2615))
- `/api/v1/datasets/{dataset_id}/fields` new endpoint to list and create dataset fields ([#2615](https://github.com/argilla-io/argilla/issues/2615))
- `/api/v1/datasets/{dataset_id}/questions/{question_id}` new endpoint to delete a dataset questions ([#2615](https://github.com/argilla-io/argilla/issues/2615))
- `/api/v1/datasets/{dataset_id}/fields/{field_id}` new endpoint to delete a dataset field ([#2615](https://github.com/argilla-io/argilla/issues/2615))
- `/api/v1/workspaces/{workspace_id}` new endpoint to get workspaces by id ([#2615](https://github.com/argilla-io/argilla/issues/2615))
- `/api/v1/responses/{response_id}` new endpoint to update and delete a response ([#2615](https://github.com/argilla-io/argilla/issues/2615))
- `/api/v1/datasets/{dataset_id}/records` new endpoint to create and list dataset records ([#2615](https://github.com/argilla-io/argilla/issues/2615))
- `/api/v1/me/datasets` new endpoint to list user visible datasets ([#2615](https://github.com/argilla-io/argilla/issues/2615))
- `/api/v1/me/dataset/{dataset_id}/records` new endpoint to list dataset records with user responses ([#2615](https://github.com/argilla-io/argilla/issues/2615))
- `/api/v1/me/datasets/{dataset_id}/metrics` new endpoint to get the dataset user metrics ([#2615](https://github.com/argilla-io/argilla/issues/2615))
- `/api/v1/me/records/{record_id}/responses` new endpoint to create record user responses ([#2615](https://github.com/argilla-io/argilla/issues/2615))
...
- Support for `FeedbackDataset` in Python client (parent PR [#2615](https://github.com/argilla-io/argilla/issues/2615), and nested PRs: \[#2949\], \[#2827\], \[#2943\], \[#2945\], \[#2962\], and \[#3003\])
...
- `tokens_length` metrics function returns empty data ([#3045](https://github.com/argilla-io/argilla/pull/3045))
- `token_length` metrics function returns empty data ([#3045](https://github.com/argilla-io/argilla/pull/3045))
- `mention_length` metrics function returns empty data ([#3045](https://github.com/argilla-io/argilla/pull/3045))
- `entity_density` metrics function returns empty data ([#3045](https://github.com/argilla-io/argilla/pull/3045))
...
- `tokens_length` metrics function has been deprecated and will be removed in 1.10.0 ([#3045](https://github.com/argilla-io/argilla/pull/3045))
- `token_length` metrics function has been deprecated and will be removed in 1.10.0 ([#3045](https://github.com/argilla-io/argilla/pull/3045))
- `mention_length` metrics function has been deprecated and will be removed in 1.10.0 ([#3045](https://github.com/argilla-io/argilla/pull/3045))
- `entity_density` metrics function has been deprecated and will be removed in 1.10.0 ([#3045](https://github.com/argilla-io/argilla/pull/3045))

### Removed

- Removed mention `density`, `tokens_length` and `chars_length` metrics from token classification metrics storage ([#3045](https://github.com/argilla-io/argilla/pull/3045))
- Removed token `char_start`, `char_end`, `tag`, and `score` metrics from token classification metrics storage ([#3045](https://github.com/argilla-io/argilla/pull/3045))
- Removed tags-related metrics from token classification metrics storage ([#3045](https://github.com/argilla-io/argilla/pull/3045))
...
- `ARGILLA_HOME_PATH` new environment variable ([#2564](https://github.com/argilla-io/argilla/issues/2564)).
- `ARGILLA_DATABASE_URL` new environment variable ([#2564](https://github.com/argilla-io/argilla/issues/2564)).
- Basic support for user roles with `admin` and `annotator` ([#2564](https://github.com/argilla-io/argilla/issues/2564)).
- `id`, `first_name`, `last_name`, `role`, `inserted_at` and `updated_at` new user fields ([#2564](https://github.com/argilla-io/argilla/issues/2564)).
- `/api/users` new endpoint to list and create users ([#2564](https://github.com/argilla-io/argilla/issues/2564)).
- `/api/users/{user_id}` new endpoint to delete users ([#2564](https://github.com/argilla-io/argilla/issues/2564)).
- `/api/workspaces` new endpoint to list and create workspaces ([#2564](https://github.com/argilla-io/argilla/issues/2564)).
- `/api/workspaces/{workspace_id}/users` new endpoint to list workspace users ([#2564](https://github.com/argilla-io/argilla/issues/2564)).
- `/api/workspaces/{workspace_id}/users/{user_id}` new endpoint to create and delete workspace users ([#2564](https://github.com/argilla-io/argilla/issues/2564)).
- `argilla.tasks.users.migrate` new task to migrate users from old YAML file to database ([#2564](https://github.com/argilla-io/argilla/issues/2564)).
- `argilla.tasks.users.create` new task to create a user ([#2564](https://github.com/argilla-io/argilla/issues/2564)).
- `argilla.tasks.users.create_default` new task to create a user with default credentials ([#2564](https://github.com/argilla-io/argilla/issues/2564)).
- `argilla.tasks.database.migrate` new task to execute database migrations ([#2564](https://github.com/argilla-io/argilla/issues/2564)).
- `release.Dockerfile` and `quickstart.Dockerfile` now creates a default `argilladata` volume to persist data ([#2564](https://github.com/argilla-io/argilla/issues/2564)).
...
- `ARGILLA_USERS_DB_FILE` environment variable now it's only used to migrate users from YAML file to database ([#2564](https://github.com/argilla-io/argilla/issues/2564)).
- `full_name` user field is now deprecated and `first_name` and `last_name` should be used instead ([#2564](https://github.com/argilla-io/argilla/issues/2564)).
- `password` user field now requires a minimum of `8` and a maximum of `100` characters in size ([#2564](https://github.com/argilla-io/argilla/issues/2564)).
- `quickstart.Dockerfile` image default users from `team` and `argilla` to `admin` and `annotator` including new passwords and API keys ([#2564](https://github.com/argilla-io/argilla/issues/2564)).
- Datasets to be managed only by users with `admin` role ([#2564](https://github.com/argilla-io/argilla/issues/2564)).
...
- `email` user field ([#2564](https://github.com/argilla-io/argilla/issues/2564)).
- `disabled` user field ([#2564](https://github.com/argilla-io/argilla/issues/2564)).
- Support for private workspaces ([#2564](https://github.com/argilla-io/argilla/issues/2564)).
- `ARGILLA_LOCAL_AUTH_DEFAULT_APIKEY` and `ARGILLA_LOCAL_AUTH_DEFAULT_PASSWORD` environment variables. Use `python -m argilla.tasks.users.create_default` instead ([#2564](https://github.com/argilla-io/argilla/issues/2564)).
