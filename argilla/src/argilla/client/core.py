...
"""
Core implementation of the Argilla client.
"""
...
from typing import TYPE_CHECKING, List, Optional, Union, overload, Dict
...
class Argilla(_api.APIClient, SpacesDeploymentMixin, NotebookHTMLReprMixin):
    ...
    def from_credentials(cls, api_url: Optional[str] = None, api_key: Optional[str] = None,
                         workspace: Optional[str] = None, extra_headers: Optional[dict] = None,
                         **kwargs) -> "Argilla":
